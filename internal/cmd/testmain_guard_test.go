...
//
// The build tag keeps this out of the integration build, which has its own
// TestMain in integration_testmain_test.go; that one applies the same guard
// before starting its Dolt container.
